...
description: "Autonomously generate high-value work items from vision goals, security/quality gaps, and codebase signals when backlog is thin; produces 0–8 intake items with strong deduplication to avoid spam."
---
