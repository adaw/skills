---
name: fabric-init
description: "Bootstrap {WORK_ROOT}/ into a clean, idempotent Fabric runtime: directory structure, templates, state.md, vision.md, backlog.md. Designed for one-command start: RUN -> init -> loop."
---
